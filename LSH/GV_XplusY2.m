...
pairs=[2001 2002;10 15; 10 17;10 18; 10 40; 10 54; 10 57; 10 132 ; 10 287;  12 17; 12 47; 12 18; 12 822;12 826;15 36;15 17; 15 20;15 47; 15 223; 15 52;15 287;15 608; 17 30; 17 32;17 45; 17 47;17 54; 17 57; 17 71; 17 141; 17 163;17 223; 17 344; 32 54;32 132;52 54; 53 54; 54 113;18 27]
...
%					[candidate, ia, ib]=intersect(cand_concep1(1:200),cand_concep2(1:200)); 
...
%	end
	...
	candidates=[]
	for iC1=1:length(concep1(vals1>0))
		if sum(strcmp(exclude_list,vocab(concep1(iC1))))==0
			candidates=[candidates find(BoWT(concep1(iC1),:))];
		end
	end
	for iC2=1:length(concep2(vals2>0))
		if sum(strcmp(exclude_list,vocab(concep2(iC2))))==0
...
%	end
	...
	textrep= 0.5*core_concepts+ 0.5*sum(add_concepts,2);
...
%	end
	...
	outdir='/home/gvaca/ECCV2014/Bing/Train/search/outs_sum2/';
	imgs_dir='/home/gvaca/ECCV2014/Bing/Train/search/imgs/';
	if(~exist(outdir,'dir'))
		mkdir(outdir);
	end
