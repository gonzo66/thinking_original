...
feat_imageNet=feat_imageNet';
	...
	ccvLshSave(index, sprintf('lsh_dev_IN5.mat'));
...
%	[nnids2 nndists2] = ccvLshKnn(index, featIN , feat_imageNet(:,1:num_queries), num_neig);
	[nnids2 nndists2] = ccvLshKnn(index, featIN , feat_imageNet(:,1:2000), num_neig);
	save('ret_dev_IN4.mat','nnids2', 'nndists2','-v7.3');  
...
save('ret_dev_IN2.mat','nnids2', 'nndists2','-v7.3');  
