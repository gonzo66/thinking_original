...
feat_Query=feat_Query';
	...
	index = ccvLshCreate(ntables, nfuncs, 'l2', 'l2', 1, dim, .25, 5000);
...
save('ret_dev_IN_Oxford_1k.mat','nnids2', 'nndists2','-v7.3');  
